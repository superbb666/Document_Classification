...
LastEditors: Kai Niu
LastEditTime: 2021-01-09 05:41:45
'''
...
def main(args: argparse.ArgumentParser):
    ...
    output_dir = '''lr_%f_dropout_rate_%f_filter_size_%d_kernel_size_%s_batch_size_%d_epochs_%d''' % (
    ...
    train_dataset = News20Dataset(
        X_train, y_train, "../data/glove/glove.6B.300d.txt", 200)
    val_dataset = News20Dataset(
        X_test, y_test, "../data/glove/glove.6B.300d.txt", 200)
    ...
    model.word_embeddings.weights = get_pretrained_weights(
        "../data/glove", train_dataset.vocab, 300, dev)
    model.train()
    model.to(dev)
